...
export function DayDesign() {
  ...
  // --- Phase 1: Diseño Premium (0 to 0.33) ---
  const text1Opacity = useTransform(smoothProgress, [0, 0.1, 0.28, 0.33], [1, 1, 1, 0]);
  const text1Typewriter = useTransform(smoothProgress, [0, 0.12], [0, 1]);
  const text1Y = useTransform(smoothProgress, [0.28, 0.33], [0, -40]);
  const img1Scale = useTransform(smoothProgress, [0, 0.28, 0.33], [1, 1.1, 1.2]);
  const img1Opacity = useTransform(smoothProgress, [0, 0.28, 0.33], [1, 1, 0]);
  const img1Blur = useTransform(smoothProgress, [0.28, 0.33], [0, 10]);

  // --- Phase 2: Código Escalonable (0.33 to 0.66) ---
  const text2Opacity = useTransform(smoothProgress, [0.33, 0.38, 0.61, 0.66], [0, 1, 1, 0]);
  const text2Typewriter = useTransform(smoothProgress, [0.35, 0.45], [0, 1]);
  const text2Y = useTransform(smoothProgress, [0.33, 0.38, 0.61, 0.66], [40, 0, 0, -40]);
  const img2Scale = useTransform(smoothProgress, [0.33, 0.38, 0.61, 0.66], [0.85, 1, 1, 1.15]);
  const img2Opacity = useTransform(smoothProgress, [0.33, 0.38, 0.61, 0.66], [0, 1, 1, 0]);
  const img2Blur = useTransform(smoothProgress, [0.61, 0.66], [0, 10]);

  // --- Phase 3: Neuromarketing Visual (0.66 to 1.0) ---
  const text3Opacity = useTransform(smoothProgress, [0.66, 0.71, 0.95, 1], [0, 1, 1, 0]);
  const text3Typewriter = useTransform(smoothProgress, [0.68, 0.78], [0, 1]);
  const text3Y = useTransform(smoothProgress, [0.66, 0.71, 0.95, 1], [40, 0, 0, -40]);
  const img3Scale = useTransform(smoothProgress, [0.66, 0.71, 0.95, 1], [0.85, 1, 1, 1.15]);
  const img3Opacity = useTransform(smoothProgress, [0.66, 0.71, 0.95, 1], [0, 1, 1, 0]);
